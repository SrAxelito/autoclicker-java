...
public class IndicadorEstado extends JComponent {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.setColor(activo ? Tema.EXITO_FONDO : Tema.TARJETA);
        g2.fill(forma);
        g2.setColor(activo ? Tema.EXITO_BORDE : Tema.BORDE);
        g2.draw(forma);

        float cx = 22;
        float cy = h / 2f;
        Color colorPunto = activo ? Tema.EXITO : Tema.TEXTO_DESHABILITADO;
        ...
        g2.setFont(getFont());
        g2.setColor(activo ? Tema.mezclar(Tema.EXITO, Color.BLACK, 0.25f) : Tema.TEXTO);
